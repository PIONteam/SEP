...
public class daftar2Activity extends AppCompatActivity implements
    ...
    String id_pengguna, nama_lengkap, nama_pengguna, alamat, email, no_tlp, kata_sandi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //cek session login jika Benar maka langsung buka home sesudah
        ...
        // Assign views
        mPhoneNumberViews = findViewById(R.id.layoute1);
        mSignedInViews = findViewById(R.id.layoute2);

        mStatusText = findViewById(R.id.textView29);
        mDetailText = findViewById(R.id.textView2);

        mPhoneNumberField = findViewById(R.id.editText6);
        mVerificationField = findViewById(R.id.editText2);

        mStartButton = findViewById(R.id.button17);
        mVerifyButton = findViewById(R.id.button);
        mResendButton = findViewById(R.id.button8);
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    // Invalid request
                    // [START_EXCLUDE]
                    mPhoneNumberField.setError("nomor telepon salah");
                    // [END_EXCLUDE]
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        ...
        if (uiState == STATE_CODE_SENT) {
            // Signed out
            mPhoneNumberViews.setVisibility(View.GONE);
            mSignedInViews.setVisibility(View.VISIBLE);

            enableViews(mPhoneNumberField,mPhoneNumberViews);
    ...
    private boolean validatePhoneNumber() {
        ...
        if (TextUtils.isEmpty(phoneNumber)) {
            mPhoneNumberField.setError("nomer telepon tidak boleh kosong");
            return false;
        }
